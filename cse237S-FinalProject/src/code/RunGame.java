...
public class RunGame {
	public static void main (String[] args) {
		...
		System.out.println("Please enter your desired maze size in the following format: width,height (minimum of 50)");
		boolean flag = false;
		int x = 0;
		int y = 0;
		...
		while (!flag) {
			...
			try {
				if (Integer.parseInt(s[0]) < 50 || Integer.parseInt(s[1]) < 50) {
